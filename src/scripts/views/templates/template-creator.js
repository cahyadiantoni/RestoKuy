...
const createRestaurantListTemplate = (restaurant) => `
    ...
    <a href="#/detail/${restaurant.id || '-'}">
            <div class="list-thumbnail">
                <img class="lazyload list-item__thumbnail" tabindex="0" class="card-image" crossorigin="anonymous" alt="${restaurant.name || '-'}" src="${CONFIG.BASE_IMAGE_URL_SMALL + restaurant.pictureId || 'https://picsum.photos/id/666/800/450?grayscale'}"/>
